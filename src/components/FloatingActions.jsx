...
export default function FloatingActions() {
  ...
  return (
    ...
    >
      <a
        href={waHref(primary, "Hi Plated! I'd like to make a reservation.")}
        target="_blank"
        rel="noreferrer"
        aria-label="Chat on WhatsApp"
        className="grid h-12 w-12 place-items-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/25 transition hover:-translate-y-0.5 hover:shadow-xl sm:h-14 sm:w-14"
      >
      ...
      <a
        ...
        aria-label="Call us"
        className="grid h-12 w-12 place-items-center rounded-full bg-chili text-cream shadow-lg shadow-black/25 transition hover:-translate-y-0.5 hover:shadow-xl sm:h-14 sm:w-14"
      >
